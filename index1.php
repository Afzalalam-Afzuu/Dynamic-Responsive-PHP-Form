...
<html lang="en">
<head>
<title>Welcome to the Niks Technology Ltd.</title>
...
<body>
	...
	<div class="agile-header">
		<h1>Niks Technology Ltd.</h1>
		<p><span style="color: #31e06f; font-weight: bold;">Address:</span><br> 501 Shiv Laxmi Plaza, opposite Rajendra Nagar Main Road, Kankarbagh, Patna, Bihar 800020 <br><br> Mobile No : 9031044450</p>
	</div>
	

	<?php
        if($insert == true){
        echo "<p class='submitMsg'>Thanks for submitting your form. We are happy to see you joining us for the Niks Technology Ltd.</p>";
        }
    ?>
